// Jeffrey Lansford
// 2/25/18
// calculates what has been tokenized
    ...
    { 
      ...
      case Mult:
           ...
           { 
             ...
             case Mult:   return eval_expr_4(opn1, opr1, opn2, Mult ) ;
             case Divide: return eval_expr_4(opn1, opr1, opn2, Mult ) ;
           }
      case Divide:
           switch (opr1)
           { 
             ...
             case Mult:   return eval_expr_4(opn1, opr1, opn2, Divide ) ;
             case Divide: return eval_expr_4(opn1, opr1, opn2, Divide ) ;
           }
      case Operand:
           error(20);
      case EOF:
